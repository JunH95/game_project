...
관문 5개 + **기억 관문**(넋의 생전 기억이 무대, design.md 5-0-4)을 반복해서 돌고 결말이 6개다.
전체 스토리는 vision.md §5. 고증은 재료지 규칙이 아니다(vision.md 1-B).
시대는 **개화기(구한말)** — 넋을 보내는 본업이 안 돼서 무당이 직접 저승으로 간다(vision.md 1-C).
...
- `docs/vision.md` — 비전·**전체 스토리(§5)**·톤·무드·재미 방향·떡밥·아트 방향 (WHY / 무엇을 느끼게)
